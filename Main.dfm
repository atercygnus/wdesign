object fmMain: TfmMain
  ...
  object dxLayoutControl1: TdxLayoutControl
    ...
    TabOrder = 0
    AutoSize = True
    object grdOrders: TcxGrid
      Left = 10
      Top = 10
      Width = 1079
      Height = 495
      TabOrder = 0
      object viwOrders: TcxGridDBTableView
        Navigator.Buttons.CustomButtons = <>
        DataController.DataSource = dmMain.dsOrders
        DataController.DetailKeyFieldNames = 'order_id'
        DataController.KeyFieldNames = 'order_id'
        ...
        object viwOrdersorder_id: TcxGridDBColumn
        ...
        object viwOrderscustomer_name: TcxGridDBColumn
          DataBinding.FieldName = 'customer_name'
          HeaderAlignmentHorz = taCenter
          Options.Sorting = False
          Width = 119
        end
        object viwOrdersaddress: TcxGridDBColumn
          DataBinding.FieldName = 'address'
          HeaderAlignmentHorz = taCenter
          Width = 139
        end
        object viwOrderscomment: TcxGridDBColumn
        ...
        object viwOrdersstatus_name: TcxGridDBColumn
          DataBinding.FieldName = 'status_name'
          HeaderAlignmentHorz = taCenter
          Width = 154
        end
        object viwOrdersdue_date: TcxGridDBColumn
          DataBinding.FieldName = 'due_date'
          HeaderAlignmentHorz = taCenter
          Width = 102
        end
        object viwOrderstotal_cost: TcxGridDBColumn
          DataBinding.FieldName = 'total_cost'
          HeaderAlignmentHorz = taCenter
          Width = 151
        end
        object viwOrderspayed: TcxGridDBColumn
          Caption = #1059#1087#1083#1072#1095#1077#1085#1086
          DataBinding.FieldName = 'payed'
          HeaderAlignmentHorz = taCenter
          Width = 115
        end
        object viwOrdersremains: TcxGridDBColumn
      ...
      object viwServicesOrdered: TcxGridDBBandedTableView
        ...
        object viwServicesOrderedservice_name: TcxGridDBBandedColumn
        ...
        object viwServicesOrderedord_svc_id: TcxGridDBBandedColumn
          DataBinding.FieldName = 'ord_svc_id'
          Visible = False
          VisibleForCustomization = False
          Position.BandIndex = 0
          Position.ColIndex = 1
        ...
        object viwServicesOrderedservice_id: TcxGridDBBandedColumn
        ...
        object viwServicesOrderedprice_id: TcxGridDBBandedColumn
          DataBinding.FieldName = 'price_id'
          Visible = False
          VisibleForCustomization = False
          Position.BandIndex = 0
          Position.ColIndex = 3
        ...
        object viwServicesOrderedquantity: TcxGridDBBandedColumn
        ...
        object viwServicesOrderedorder_id: TcxGridDBBandedColumn
          DataBinding.FieldName = 'order_id'
          Visible = False
          VisibleForCustomization = False
          Position.BandIndex = 0
        ...
        object viwServicesOrderedstatus_id: TcxGridDBBandedColumn
        ...
        object viwServicesOrderedestimation: TcxGridDBBandedColumn
          DataBinding.FieldName = 'estimation'
          HeaderAlignmentHorz = taCenter
          Width = 85
          Position.BandIndex = 0
          Position.ColIndex = 7
        ...
        object viwServicesOrderedstatus_name: TcxGridDBBandedColumn
          DataBinding.FieldName = 'status_name'
          HeaderAlignmentHorz = taCenter
          Width = 103
          Position.BandIndex = 0
        ...
        object viwServicesOrderedprice_per_unit: TcxGridDBBandedColumn
        ...
        object viwServicesOrderedtotal_price: TcxGridDBBandedColumn
      ...
      object lvlOrders: TcxGridLevel
        GridView = viwOrders
        object lvlServicesOrdered: TcxGridLevel
          GridView = viwServicesOrdered
        end
      end
    end
    ...
    object itmgrdOrders: TdxLayoutItem
  ...
  object bmrMain: TdxBarManager
    ...
    Categories.Visibles = (
      True)
    ImageOptions.LargeImages = imlMain
    ...
    object bmrTools: TdxBar
      ...
      ItemLinks = <
        item
          Visible = True
          ItemName = 'btnNewProject'
        end
        item
          Visible = True
          ItemName = 'btnCreateOrderPosition'
        end
        item
          Visible = True
          ItemName = 'btnEditCustomers'
        end
        item
          Visible = True
          ItemName = 'btnPayment'
    ...
    object btnNewProject: TdxBarButton
      Action = actNewOrder
      Category = 0
      LargeImageIndex = 0
    end
    object btnCreateOrderPosition: TdxBarButton
      Action = actNewServiceOrder
      Category = 0
      LargeImageIndex = 1
    end
    object btnEditCustomers: TdxBarButton
      Action = actNewCustomer
      Category = 0
      LargeImageIndex = 3
    end
    object btnPayment: TdxBarButton
      Action = actNewPayment
      Category = 0
      LargeImageIndex = 4
    end
  end
  object imlMain: TcxImageList
    Height = 32
    Width = 32
    FormatVersion = 1
    DesignInfo = 27001208
    ImageInfo = <
      ...
      item
        Image.Data = {
          ...
          
          ...
          
  ...
  object actMain: TActionList
    ...
    object actNewServiceOrder: TAction
      Caption = 'New Order Position'
      OnExecute = actNewServiceOrderExecute
    end
    object actEditCustomers: TAction
      Caption = 'Edit Customers'
      OnExecute = actEditCustomersExecute
    end
    object actNewPayment: TAction
      Caption = 'actNewPayment'
      OnExecute = actNewPaymentExecute
    end
